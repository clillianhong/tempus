...
public class RocketController extends WorldController implements ContactListener {
	...
	private static final String BACKGROUND_TEXTURE = "shared/ice.png";
	...
	public void loadContent(AssetManager manager) {
		...
		background = createTexture(manager, BACKGROUND_TEXTURE, false);
	...
	public void update(float dt) {
		...
		if (input.pressedLeftMouseButton()){
			System.out.println("Aiming: " + input.getMousePosition());
		}
		if (input.releasedLeftMouseButton()){
			System.out.println("Dash");
		}
		if (input.pressedRightMouseButton()){
