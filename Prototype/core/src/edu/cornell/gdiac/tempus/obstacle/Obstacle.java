 ...
 */
package edu.cornell.gdiac.tempus.obstacle;

import com.badlogic.gdx.math.*;
import com.badlogic.gdx.physics.box2d.*;
import com.badlogic.gdx.physics.box2d.BodyDef.BodyType;

import edu.cornell.gdiac.tempus.*;  // For GameCanvas
...
public abstract class Obstacle {
	...
	/** Whether or not the object belongs in the present, past, or both worlds.
	 * 1 = present, 2 = past, 3 = both*/
	...
	/**
	 * Returns whether the object is in the present world or past world, or both. (1,2,3 respectively)
	 * @return whether the object is in the present world.
	 */
	public int getSpace(){return space;}

	/**
	 * Sets the space of the object (1 for present, 2 for past, 3 for both)
	 * @param value
	 */
	public void setSpace(int value){space = value;}
	/**
