 ...
 * to extend this class without serious thread synchronization problems.  There is a reason we do not initialize in
 * constructors in CUGL. This variation of LwjglApplication exposes the audio initialization so we can override it
 * later.
 */
